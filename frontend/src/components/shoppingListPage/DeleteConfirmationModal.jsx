export default function DeleteConfirmationModal({ shoppingList, onCancel, onConfirm }) {
    if (!shoppingList) return null;

    return (
        <div className="fixed inset-0 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-6 rounded shadow-lg w-1/3 text-center">
                <h3 className="text-xl font-bold mb-4">Ar tikrai norite ištrinti prekių krepšelį „{shoppingList.name}“?</h3>
