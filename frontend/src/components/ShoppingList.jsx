...
//   // Užkraunam receptų ingredientus iš localStorage
//   useEffect(() => {
//     const saved = localStorage.getItem("selectedIngredients");
//     if (saved) {
//       try {
...
//   // Užkraunam kitus ingredientus iš serverio
//   const fetchData = async () => {
//     try {
//       setLoading(true);
//       const data = await fetchShoppingLists(userId);
...
//                       Sąrašas #{list.id} • {new Date(list.createdAt).toLocaleString()}
//                     </div>

//                     {list.ingredients?.map((ing, i) => (
//                       <div
//                         key={i}
//                         className="grid grid-cols-6 border border-orange-300 bg-orange-50 text-center"
//                       >
//                         <div className="p-2">{i + 1}</div>
//                         <div className="p-2">{ing.ingredientName}</div>
//                         <div className="p-2">{ing.quantity}</div>
